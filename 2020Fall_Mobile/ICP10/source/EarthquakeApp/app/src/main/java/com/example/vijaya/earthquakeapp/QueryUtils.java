...
public class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData2(String requestUrl) {
        // An ArrayList which is empty so that we can start adding earthquakes to it
        List<Earthquake> earthquakes = new ArrayList<>();

        //  URL object which is used to store the link
        URL url = null;

        //  rest call in the form of string stored here
        String jsonResponse = "";
